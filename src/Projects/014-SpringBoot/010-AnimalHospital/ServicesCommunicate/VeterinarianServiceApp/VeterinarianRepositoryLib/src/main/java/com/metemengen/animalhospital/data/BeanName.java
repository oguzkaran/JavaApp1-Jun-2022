package com.metemengen.animalhospital.data;

public final class BeanName {
    private BeanName()
    {}
    public static final String VETERINARIAN_REPOSITORY = "com.metemengen.animalhospital.repository.veterinarian";
    public static final String ANIMAL_REPOSITORY = "com.metemengen.animalhospital.repository.animal";
    public static final String OWNER_REPOSITORY = "com.metemengen.animalhospital.repository.owner";
    ...
    public static final String MAPPER_CONFIG = "com.metemengen.animalhospital.config.mapper";
}
